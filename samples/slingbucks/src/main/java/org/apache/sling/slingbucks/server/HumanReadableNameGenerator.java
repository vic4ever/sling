...
import org.apache.sling.slingbucks.utility.Mnemo;
...
@Service
public class HumanReadableNameGenerator implements NodeNameGenerator {
    ...
    {
        Mnemo instance = Mnemo.getInstance();
        if(SlingbucksConstants.ORDERS_PATH.equals(parentPath)) {
            final StringBuilder name = new StringBuilder();
            ID++;
            name.append(instance.fromInteger(random.nextInt()));
